...
import org.jungmha.infra.database.Indexes;
...
public class Userprofiles extends TableImpl<UserprofilesRecord> {
     ...
     */
    public final TableField<UserprofilesRecord, String> AUTHEN_KEY = createField(DSL.name("authen_key"), SQLDataType.VARCHAR(70), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_USERS_EMAIL, Indexes.IDX_USERS_PUBLIC_KEY);
    }
