...
public class DogwalkbookingsRecord extends UpdatableRecordImpl<DogwalkbookingsRecord> implements Record10<Integer, Integer, Integer, Integer, String, LocalTime, LocalTime, LocalTime, OffsetDateTime, Integer> {
    ...
    @Override
    public Row10<Integer, Integer, Integer, Integer, String, LocalTime, LocalTime, LocalTime, OffsetDateTime, Integer> valuesRow() {
    ...
    @Override
    public DogwalkbookingsRecord value10(Integer value) {
        setTotal(value);
        return this;
    }

    @Override
    public DogwalkbookingsRecord values(Integer value1, Integer value2, Integer value3, Integer value4, String value5, LocalTime value6, LocalTime value7, LocalTime value8, OffsetDateTime value9, Integer value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DogwalkbookingsRecord(Integer bookingId, Integer walkerId, Integer userId, Integer dogId, String status, LocalTime timeStart, LocalTime timeEnd, LocalTime duration, OffsetDateTime timestamp, Integer total) {
        super(Dogwalkbookings.DOGWALKBOOKINGS);
