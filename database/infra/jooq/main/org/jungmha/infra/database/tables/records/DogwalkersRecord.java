...
public class DogwalkersRecord extends UpdatableRecordImpl<DogwalkersRecord> implements Record8<Integer, Integer, String, String, String, Integer, Integer, Integer> {
     ...
     */
    public DogwalkersRecord setIdCardNumber(String value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public DogwalkersRecord value4(String value) {
    ...
    @Override
    public DogwalkersRecord values(Integer value1, Integer value2, String value3, String value4, String value5, Integer value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DogwalkersRecord(Integer walkerId, Integer userId, String locationName, String idCardNumber, String verification, Integer priceSmall, Integer priceMedium, Integer priceBig) {
        super(Dogwalkers.DOGWALKERS);
