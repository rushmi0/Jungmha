...
class ChaCha20Test {
    ...
    private val originalObject = win.rushmi0.jungmha.database.form.UserProfileForm(
        firstName = "สมหมาย",
        lastName = "ใจหมา",
    ...
    fun testEncryptAndDecrypt() {
        ...
        val decryptedUserProfileForm = objectMapper.convertValue(decryptedText, win.rushmi0.jungmha.database.form.UserProfileForm::class.java)
