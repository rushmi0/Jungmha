...
fun main() {
    ...
    val data = println(Bech32.encode("npub", pubKeyA.HexToByteArray().toBech32Data("ln").fiveBitData))
    println("npub1ujevvncwfe22hv6d2cjv6pqwqhkvwlcvge7vgm3vcn2max9tu03sgze8ry".length)
