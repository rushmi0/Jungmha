package win.rushmi0.jungmha.routes.api.v1.dogs
...
import win.rushmi0.jungmha.database.statement.DogsServiceImpl
...
class DogController @Inject constructor(
    ...
    ): List<win.rushmi0.jungmha.database.field.DogField> {
        return try {
