...
public class DogsRecord extends UpdatableRecordImpl<DogsRecord> implements Record4<Integer, String, String, DogSize> {
     ...
     */
    public DogsRecord setSize(DogSize value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public Row4<Integer, String, String, DogSize> valuesRow() {
    ...
    @Override
    public DogsRecord value4(DogSize value) {
        setSize(value);
        return this;
    }

    @Override
    public DogsRecord values(Integer value1, String value2, String value3, DogSize value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DogsRecord(Integer dogId, String dogImage, String breedName, DogSize size) {
        super(Dogs.DOGS);
     ...
     * Create a detached, initialised DogsRecord
     */
    public DogsRecord(nu.studer.sample.tables.pojos.Dogs value) {
        super(Dogs.DOGS);
