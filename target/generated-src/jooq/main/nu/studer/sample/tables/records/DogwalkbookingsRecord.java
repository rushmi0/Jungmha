...
public class DogwalkbookingsRecord extends UpdatableRecordImpl<DogwalkbookingsRecord> implements Record9<Integer, Integer, Integer, Integer, State, LocalTime, LocalTime, LocalTime, OffsetDateTime> {
     ...
     */
    public DogwalkbookingsRecord setStatus(State value) {
        set(4, value);
        return this;
    }
    ...
    @Override
    public Row9<Integer, Integer, Integer, Integer, State, LocalTime, LocalTime, LocalTime, OffsetDateTime> valuesRow() {
    ...
    @Override
    public DogwalkbookingsRecord value5(State value) {
        setStatus(value);
        return this;
    }
    ...
    @Override
    public DogwalkbookingsRecord values(Integer value1, Integer value2, Integer value3, Integer value4, State value5, LocalTime value6, LocalTime value7, LocalTime value8, OffsetDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DogwalkbookingsRecord(Integer bookingId, Integer walkerId, Integer userId, Integer dogId, State status, LocalTime timeStart, LocalTime timeEnd, LocalTime duration, OffsetDateTime timestamp) {
        super(Dogwalkbookings.DOGWALKBOOKINGS);
