...
public class DogwalkersRecord extends UpdatableRecordImpl<DogwalkersRecord> implements Record8<Integer, Integer, String, Long, Verify, Integer, Integer, Integer> {
     ...
     */
    public DogwalkersRecord setVerification(Verify value) {
        set(4, value);
        return this;
    }
    ...
    @Override
    public Row8<Integer, Integer, String, Long, Verify, Integer, Integer, Integer> valuesRow() {
    ...
    @Override
    public DogwalkersRecord value5(Verify value) {
    ...
    @Override
    public DogwalkersRecord values(Integer value1, Integer value2, String value3, Long value4, Verify value5, Integer value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DogwalkersRecord(Integer walkerId, Integer userId, String locationName, Long idCardNumber, Verify verification, Integer priceSmall, Integer priceMedium, Integer priceBig) {
        super(Dogwalkers.DOGWALKERS);
     ...
     * Create a detached, initialised DogwalkersRecord
     */
    public DogwalkersRecord(nu.studer.sample.tables.pojos.Dogwalkers value) {
        super(Dogwalkers.DOGWALKERS);
